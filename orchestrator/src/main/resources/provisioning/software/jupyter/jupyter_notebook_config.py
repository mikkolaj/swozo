...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$4147z0on4oxi+nvK5KEz0g$LUNSkiNpP/0A4S9xeECeIlMacOUeWFWKeUj79c/DHiw'
...
#  Choices: any of ['sha3_256', 'blake2s', 'sha512', 'sha3_512', 'sha3_224', 'sha224', 'sha384', 'sha1', 'blake2b', 'sha256', 'sha3_384', 'md5']
#  Default: 'sha256'

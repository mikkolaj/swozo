...
class SoziselRequestTemplate {
    static final String REGISTER_QUERY = "mutation Register($input: RegisterInput!) {\n" +
    ...
    static final String LOGIN_QUERY = "mutation Login($input: LoginInput!) {\n" +
            "    login(input: $input) {\n" +
            "        token\n" +
            "        __typename\n" +
            "    }\n" +
    ...
    static final String CREATE_SESSION_TEMPLATE_QUERY = "mutation CreateSessionTemplate($input: CreateSessionTemplateInput!) {\n" +
    ...
    static final String PLAN_SESSION_QUERY = "mutation CreateSession($input: CreateSessionInput!) {\n" +
    ...
    static final String START_SESSION_QUERY = "mutation StartSession($id: ID!) {\n" +
            "    startSession(id: $id) {\n" +
            "        id\n" +
            "        __typename\n" +
            "    }\n" +
    ...
    static final String GENERATE_JITSI_TOKEN_QUERY = "query GenerateJitsiToken($displayName: String!, $email: String!, $roomId: ID!) {\n" +
    ...
    static final String REGISTER_VARIABLES = "{\n" +
            "    \"input\": {\n" +
            "      \"email\": \"%s\",\n" +
            "      \"firstName\": \"%s\",\n" +
            "      \"lastName\": \"%s\",\n" +
    ...
    static final String LOGIN_VARIABLES = "{\n" +
            "    \"input\": {\n" +
            "      \"email\": \"%s\",\n" +
            "      \"password\": \"SuperSecretPassword\"\n" +
            "    }\n" +
    ...
    static final String CREATE_SESSION_TEMPLATE_VARIABLES = "{\n" +
            "    \"input\": {\n" +
            "      \"isPublic\": false,\n" +
            "      \"estimatedTime\": %d,\n" +
            "      \"agendaEntries\": [],\n" +
    ...
    static final String PLAN_SESSION_VARIABLES = "{\n" +
            "    \"input\": {\n" +
